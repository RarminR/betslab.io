...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Free Channel: For all registered users (free tips, community)
    | VIP Channel: For paid subscribers only (premium tips)
    |
    | Channel ID format: @channelname or -100xxxxxxxx
    |
    */
    'channels' => [
        'free' => [
            'id' => env('TELEGRAM_FREE_CHANNEL_ID', ''),
            'invite_link' => env('TELEGRAM_FREE_INVITE_LINK', ''),
            'name' => 'BetsLab Community',
            'description' => 'Free tips, discussions, and community access',
        ],
        'vip' => [
            'id' => env('TELEGRAM_VIP_CHANNEL_ID', ''),
            'invite_link' => env('TELEGRAM_VIP_INVITE_LINK', ''),
            'name' => 'BetsLab VIP',
            'description' => 'Premium tips with full analysis',
        ],
    ],
